  ...
  update(){
    ...
    for(let gunn=0; gunn<9; gunn++){
      if(!this.labels[gunn]){
        ...
        this.labels[gunn].position.set(gunn*100,app.view.height-64-this.labels[gunn].height);
      ...
      if(!this.ammolabels[gunn]){
        ...
        this.ammolabels[gunn].position.set(gunn*100+32,app.view.height-this.ammolabels[gunn].height);
      ...
      if(this.guns[gunn] !== undefined){
        ...
        if (!this.sprites[gunn]) {
          ...
          this.sprites[gunn].position.set(gunn*100,app.view.height-64);
